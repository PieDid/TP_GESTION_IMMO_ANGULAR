...
export class CreateTerrainComponent implements OnInit {
  ...
  findTerrainById(id_bien: number) {
    if (id_bien == 0) {
      // ------- ajout ------- //
      this.terrain = { id_bien: null, statut: null, offre: null, prix: null, standard: null, adresseBien: null, dateSoumission: null, dateDisposition: null, revenu: null, listePhoto: null, listeVisite: null, contrat: null, proprietaire: null, superficie: null };
    } else {
      // ------- modif ------- //
      ...
      this.photoService.getPhotoByBien(id_bien).subscribe( (data) => {this.terrain.listePhoto = data});
    } // end else
